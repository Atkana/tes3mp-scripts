-- kanaBank - Release 4 - For tes3mp 0.8
...
Methods.CreateContainerForPlayer = function(playerName)
	...
	local uniqueIndex = logicHandler.CreateObjectAtLocation(scriptConfig.storageCell, location, dataTableBuilder.BuildObjectData(scriptConfig.recordRefId), packetType)
